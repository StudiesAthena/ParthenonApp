...
export const FAQPage: React.FC<FAQPageProps> = ({ theme, toggleTheme }) => {
  ...
  const faqs = [
    ...
    { q: "Quero excluir minha conta e todos os meus dados. Como faço isso?", a: "Se você deseja excluir sua conta do Parthenon e todos os dados associados a ela, basta seguir estes passos: Envie um e-mail para studiesathena2025@gmail.com. No assunto do e-mail, escreva: “Exclusão de conta – Parthenon”. No corpo do e-mail, informe: o e-mail usado para acessar o app e (opcional) o motivo da solicitação. Após a solicitação, sua conta será permanentemente excluída em até 2 dias úteis.Dados que são excluídos: (i) dados de conta e identificação (email, senha, e nome); (ii) calendário de estudos; (iii) metas, relatórios e progresso; (iv)grupos, compromissos e registros de uso. Os únicos dados mantidos temporiariamente são registros técnicos mínimos (logs), apenas quando exigidos por obrigações legais ou de segurança, e somente pelo período necessário." }
    { q: "Quero excluir apenas meus dados, mas manter minha conta. Como faço isso?", a: "Caso você queira apagar seus dados pessoais e de uso, mas manter sua conta ativa no Parthenon, o processo é semelhante: Envie um e-mail para studiesathena2025@gmail.com. No assunto do e-mail, escreva: “Exclusão de dados – Parthenon”. No corpo do e-mail, informe: o e-mail usado para acessar o app, quais dados você deseja excluir (por exemplo: histórico de estudos, calendário, relatórios). Após a solicitação, os dados indicados serão excluídos em até 2 dias úteis. Dados que são excluídos: (i) informações de estudo e progresso; (ii) calendários, metas e relatórios; (iii) registros inseridos pelo usuário. Dados que podem ser mantidos: (i) informações mínimas da conta (como e-mail), necessárias para manter o acesso ao app; (ii) registros técnicos obrigatórios por lei, quando aplicável" }
  ];
